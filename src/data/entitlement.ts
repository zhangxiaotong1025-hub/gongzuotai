...
export const ruleData: EntitlementRule[] = [
  // 日额度规则（每日刷新）
  { id: "rule1",  name: "AI设计100次/日",     code: "RULE_AI_100_DAY",       capabilityId: "cap1", quota: 100, periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新100次AI设计额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule2",  name: "AI设计300次/日",     code: "RULE_AI_300_DAY",       capabilityId: "cap1", quota: 300, periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新300次AI设计额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule3",  name: "AI设计500次/日",     code: "RULE_AI_500_DAY",       capabilityId: "cap1", quota: 500, periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新500次AI设计额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule4",  name: "4K渲染2次/日",       code: "RULE_4K_2_DAY",         capabilityId: "cap2", quota: 2,   periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新2次4K渲染额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule5",  name: "4K渲染4次/日",       code: "RULE_4K_4_DAY",         capabilityId: "cap2", quota: 4,   periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新4次4K渲染额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule6",  name: "8K渲染1次/日",       code: "RULE_8K_1_DAY",         capabilityId: "cap3", quota: 1,   periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新1次8K渲染额度", status: "active", createdAt: "2026-03-12" },
  { id: "rule7",  name: "全景图导出1次/日",   code: "RULE_PANORAMA_1_DAY",   capabilityId: "cap4", quota: 1,   periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新1次全景图导出", status: "active", createdAt: "2026-03-12" },
  { id: "rule8",  name: "全景图导出10次/日",  code: "RULE_PANORAMA_10_DAY",  capabilityId: "cap4", quota: 10,  periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新10次全景图导出", status: "active", createdAt: "2026-03-12" },
  { id: "rule9",  name: "2D效果图导出1次/日", code: "RULE_2D_1_DAY",         capabilityId: "cap5", quota: 1,   periodType: "DAY", periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每日刷新1次2D效果图导出", status: "active", createdAt: "2026-03-12" },
  // 永久权限规则
  ...
  { id: "rule19", name: "多素材批量导入",     code: "RULE_BATCH_IMPORT",         capabilityId: "cap15", quota: 1, periodType: "PERMANENT", periodValue: 0, quotaScope: "enterprise", grantType: "ONE_TIME", isCumulative: false, expirePolicy: "NEVER_EXPIRE", description: "多素材批量导入权限", status: "active", createdAt: "2026-03-12" },
  { id: "rule20", name: "批量替换",           code: "RULE_BATCH_REPLACE",        capabilityId: "cap16", quota: 1, periodType: "PERMANENT", periodValue: 0, quotaScope: "enterprise", grantType: "ONE_TIME", isCumulative: false, expirePolicy: "NEVER_EXPIRE", description: "批量替换权限", status: "active", createdAt: "2026-03-12" },
  ...
  { id: "rule22", name: "水印",               code: "RULE_WATERMARK",            capabilityId: "cap18", quota: 1, periodType: "PERMANENT", periodValue: 0, quotaScope: "enterprise", grantType: "ONE_TIME", isCumulative: false, expirePolicy: "NEVER_EXPIRE", description: "水印权限", status: "active", createdAt: "2026-03-12" },
  { id: "rule23", name: "实时渲染",           code: "RULE_REALTIME_RENDER",      capabilityId: "cap19", quota: 1, periodType: "PERMANENT", periodValue: 0, quotaScope: "enterprise", grantType: "ONE_TIME", isCumulative: false, expirePolicy: "NEVER_EXPIRE", description: "实时渲染权限", status: "active", createdAt: "2026-03-12" },
  { id: "rule24", name: "大文件上传",         code: "RULE_LARGE_FILE",           capabilityId: "cap20", quota: 1, periodType: "PERMANENT", periodValue: 0, quotaScope: "enterprise", grantType: "ONE_TIME", isCumulative: false, expirePolicy: "NEVER_EXPIRE", description: "大文件上传权限", status: "active", createdAt: "2026-03-12" },
  // 存储规则
  ...
  // 充值规则（可累积）
  { id: "rule28", name: "4K渲染1次",       code: "RULE_4K_1_ONCE",      capabilityId: "cap2",  quota: 1,    periodType: "PERMANENT", periodValue: 0, quotaScope: "user", grantType: "ONE_TIME", isCumulative: true,  expirePolicy: "NEVER_EXPIRE", description: "单次4K渲染充值", status: "active", createdAt: "2026-03-12" },
  { id: "rule29", name: "8K渲染1次",       code: "RULE_8K_1_ONCE",      capabilityId: "cap3",  quota: 1,    periodType: "PERMANENT", periodValue: 0, quotaScope: "user", grantType: "ONE_TIME", isCumulative: true,  expirePolicy: "NEVER_EXPIRE", description: "单次8K渲染充值", status: "active", createdAt: "2026-03-12" },
  ...
  { id: "rule31", name: "AI积分100次",     code: "RULE_AI_100_ONCE",    capabilityId: "cap1",  quota: 100,  periodType: "PERMANENT", periodValue: 0, quotaScope: "user", grantType: "ONE_TIME", isCumulative: true,  expirePolicy: "NEVER_EXPIRE", description: "AI积分100次充值", status: "active", createdAt: "2026-03-12" },
  { id: "rule32", name: "AI积分200次",     code: "RULE_AI_200_ONCE",    capabilityId: "cap1",  quota: 200,  periodType: "PERMANENT", periodValue: 0, quotaScope: "user", grantType: "ONE_TIME", isCumulative: true,  expirePolicy: "NEVER_EXPIRE", description: "AI积分200次充值", status: "active", createdAt: "2026-03-12" },
  { id: "rule33", name: "AI积分2000次",    code: "RULE_AI_2000_ONCE",   capabilityId: "cap1",  quota: 2000, periodType: "PERMANENT", periodValue: 0, quotaScope: "user", grantType: "ONE_TIME", isCumulative: true,  expirePolicy: "NEVER_EXPIRE", description: "AI积分2000次充值", status: "active", createdAt: "2026-03-12" },
  // AI设计家规则
  { id: "rule40", name: "AI方案100次/月",  code: "RULE_AI_PLAN_100_M",  capabilityId: "cap30", quota: 100,  periodType: "MONTH", periodValue: 1, quotaScope: "user", grantType: "MONTHLY_GRANT", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每月100次AI方案生成", status: "active", createdAt: "2026-03-12" },
  { id: "rule41", name: "AI风格50次/月",   code: "RULE_AI_STYLE_50_M",  capabilityId: "cap31", quota: 50,   periodType: "MONTH", periodValue: 1, quotaScope: "user", grantType: "MONTHLY_GRANT", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每月50次AI风格迁移", status: "active", createdAt: "2026-03-12" },
  // 智能导购规则
  { id: "rule50", name: "导购推荐500次/月",code: "RULE_GUIDE_500_M",    capabilityId: "cap40", quota: 500,  periodType: "MONTH", periodValue: 1, quotaScope: "user", grantType: "MONTHLY_GRANT", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每月500次导购推荐", status: "active", createdAt: "2026-03-12" },
  ...
  // 精准客资规则
  { id: "rule60", name: "线索100条/月",    code: "RULE_LEADS_100_M",    capabilityId: "cap50", quota: 100,  periodType: "MONTH", periodValue: 1, quotaScope: "user", grantType: "MONTHLY_GRANT", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "每月100条客资线索", status: "active", createdAt: "2026-03-12" },
  // 国际3D工具规则
  { id: "rule70", name: "国际AI 200次/日", code: "RULE_INTL_AI_200_DAY", capabilityId: "cap22", quota: 200, periodType: "DAY",       periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "国际版AI设计每日200次", status: "active", createdAt: "2026-03-12" },
  { id: "rule71", name: "国际4K 3次/日",   code: "RULE_INTL_4K_3_DAY",   capabilityId: "cap23", quota: 3,   periodType: "DAY",       periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "国际版4K渲染每日3次", status: "active", createdAt: "2026-03-12" },
  ...
  { id: "rule73", name: "国际全景5次/日",  code: "RULE_INTL_PANO_5_DAY", capabilityId: "cap24", quota: 5,   periodType: "DAY",       periodValue: 1, quotaScope: "user", grantType: "DAILY_REFRESH", isCumulative: false, expirePolicy: "CLEAR_ON_EXPIRE", description: "国际版全景图每日5次", status: "active", createdAt: "2026-03-12" },
];
...
export interface BEnterprise {
  ...
  parentId?: string;
  parentName?: string;
  /** 企业整体有效期（订单授权时间不得超过此日期） */
  expireDate: string;
}

export const bEnterpriseData: BEnterprise[] = [
  // 总部（0级）
  { id: "cust1", name: "欧派家居集团股份有限公司", type: "品牌商", level: 0, expireDate: "2028-12-31" },
  { id: "cust2", name: "索菲亚家居股份有限公司", type: "品牌商", level: 0, expireDate: "2028-06-30" },
  { id: "cust3", name: "尚品宅配家居股份有限公司", type: "品牌商", level: 0, expireDate: "2027-12-31" },
  { id: "cust4", name: "金牌厨柜家居科技股份有限公司", type: "品牌商", level: 0, expireDate: "2028-03-31" },
  { id: "cust5", name: "志邦家居股份有限公司", type: "品牌商", level: 0, expireDate: "2027-09-30" },
  { id: "cust6", name: "我乐家居股份有限公司", type: "品牌商", level: 0, expireDate: "2027-12-31" },
  { id: "cust7", name: "好莱客创意家居股份有限公司", type: "品牌商", level: 0, expireDate: "2028-12-31" },
  { id: "cust8", name: "居然之家投资控股集团", type: "卖场", level: 0, expireDate: "2029-12-31" },
  { id: "cust9", name: "红星美凯龙家居集团", type: "卖场", level: 0, expireDate: "2029-06-30" },
  // 欧派子企业（1级）
  { id: "cust1-1", name: "欧派家居北京经销商", type: "经销商", level: 1, parentId: "cust1", parentName: "欧派家居集团股份有限公司", expireDate: "2028-12-31" },
  { id: "cust1-2", name: "欧派家居上海经销商", type: "经销商", level: 1, parentId: "cust1", parentName: "欧派家居集团股份有限公司", expireDate: "2028-12-31" },
  { id: "cust1-3", name: "欧派家居广州旗舰店", type: "门店", level: 1, parentId: "cust1", parentName: "欧派家居集团股份有限公司", expireDate: "2028-12-31" },
  // 欧派孙企业（2级）
  { id: "cust1-1-1", name: "欧派北京朝阳门店", type: "门店", level: 2, parentId: "cust1-1", parentName: "欧派家居北京经销商", expireDate: "2028-12-31" },
  { id: "cust1-1-2", name: "欧派北京海淀门店", type: "门店", level: 2, parentId: "cust1-1", parentName: "欧派家居北京经销商", expireDate: "2028-12-31" },
  { id: "cust1-2-1", name: "欧派上海浦东门店", type: "门店", level: 2, parentId: "cust1-2", parentName: "欧派家居上海经销商", expireDate: "2028-12-31" },
  // 索菲亚子企业（1级）
  { id: "cust2-1", name: "索菲亚华南经销商", type: "经销商", level: 1, parentId: "cust2", parentName: "索菲亚家居股份有限公司", expireDate: "2028-06-30" },
  { id: "cust2-2", name: "索菲亚西南装修合作商", type: "装修公司", level: 1, parentId: "cust2", parentName: "索菲亚家居股份有限公司", expireDate: "2028-06-30" },
  // 索菲亚孙企业（2级）
  { id: "cust2-1-1", name: "索菲亚深圳南山门店", type: "门店", level: 2, parentId: "cust2-1", parentName: "索菲亚华南经销商", expireDate: "2028-06-30" },
  // 居然之家子企业
  { id: "cust8-1", name: "居然之家北京北四环店", type: "门店", level: 1, parentId: "cust8", parentName: "居然之家投资控股集团", expireDate: "2029-12-31" },
  { id: "cust8-2", name: "居然之家上海真北店", type: "门店", level: 1, parentId: "cust8", parentName: "居然之家投资控股集团", expireDate: "2029-12-31" },
  // 红星美凯龙子企业
  { id: "cust9-1", name: "红星美凯龙杭州商场", type: "门店", level: 1, parentId: "cust9", parentName: "红星美凯龙家居集团", expireDate: "2029-06-30" },
  { id: "cust9-2", name: "红星美凯龙南京商场", type: "门店", level: 1, parentId: "cust9", parentName: "红星美凯龙家居集团", expireDate: "2029-06-30" },
  // 独立装修公司
  { id: "cust10", name: "北京金隅装饰工程有限公司", type: "装修公司", level: 0, expireDate: "2027-06-30" },
  { id: "cust11", name: "上海东易日盛装饰有限公司", type: "装修公司", level: 0, expireDate: "2027-12-31" },
  { id: "cust12", name: "深圳市名雕装饰股份有限公司", type: "装修公司", level: 0, expireDate: "2028-03-31" },
];
...
export const orderData: EntitlementOrder[] = [
  {
    ...
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 299, paymentStatus: "paid", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-12 10:05:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-12 11:15:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    id: "ord3", orderNo: "ORD202603120003", customerType: "C", customerId: "user1", customerName: "张三",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 9.9, paymentStatus: "pending", orderStatus: "pending_effect",
    ...
    statusHistory: [
      ...
      { status: "pending_effect", label: "待生效", time: "2026-03-12 12:00:02", remark: "等待支付后生效" },
    ],
  },
  {
    id: "ord4", orderNo: "ORD202603140001", customerType: "B", customerId: "cust1", customerName: "欧派家居集团股份有限公司",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 11, paymentStatus: "paid", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-14 16:05:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    // 企业入驻订单 — 跟随企业审核（已通过，生效中）
    ...
    statusHistory: [
      ...
      { status: "granted",            label: "权益生效", time: "2026-03-15 10:30:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    id: "ord6", orderNo: "ORD202603160001", customerType: "B", customerId: "cust1", customerName: "欧派家居集团股份有限公司",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 2388, paymentStatus: "paid", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-16 11:30:05", remark: "权益已发放，有效期至2027-03-16" },
    ],
  },
  {
    // 企业入驻订单 — 生效中
    ...
    statusHistory: [
      ...
      { status: "granted",            label: "权益生效", time: "2026-03-17 15:20:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    id: "ord8", orderNo: "ORD202603180001", customerType: "B", customerId: "cust4", customerName: "金牌厨柜家居科技股份有限公司",
    orderType: "system_grant", auditStatus: "auto_approved", totalAmount: 0, paymentStatus: "no_payment", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-18 08:00:05", remark: "权益已发放，订单生效中" },
    ],
  },
  {
    // 退款 — 权益已关闭
    id: "ord9", orderNo: "ORD202603190001", customerType: "C", customerId: "user2", customerName: "李四",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 169, paymentStatus: "refunded", orderStatus: "closed",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-19 15:00:05", remark: "权益已发放" },
      { status: "refunded",      label: "退款完成", time: "2026-03-20 10:00:00", remark: "客户申请退款，权益已回收" },
      { status: "closed",        label: "订单关闭", time: "2026-03-20 10:00:05", remark: "退款后权益失效，订单关闭" },
    ],
  },
  {
    // 跨3个应用的大订单 — 生效中
    id: "ord10", orderNo: "ORD202603200001", customerType: "B", customerId: "cust2", customerName: "索菲亚家居股份有限公司",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 528.8, paymentStatus: "paid", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-20 10:15:05", remark: "权益已发放至3个应用账户" },
    ],
  },
  {
    // C端用户购买 — 生效中
    id: "ord11", orderNo: "ORD202603210001", customerType: "C", customerId: "user3", customerName: "王五",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 99, paymentStatus: "paid", orderStatus: "active",
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-21 09:30:05", remark: "权益已发放" },
    ],
  },
  {
    // C端系统赠送 — 生效中
    ...
    statusHistory: [
      ...
      { status: "granted",       label: "权益生效", time: "2026-03-22 14:00:05", remark: "权益已发放" },
    ],
  },
  {
    // 内部发放 — 待审核（未处理）
  ...
  {
    // 已到期订单
    id: "ord17", orderNo: "ORD202501100001", customerType: "B", customerId: "cust8", customerName: "居然之家投资控股集团",
    orderType: "user_purchase", auditStatus: "auto_approved", totalAmount: 1999, paymentStatus: "paid", orderStatus: "expired",
    paidAt: "2025-01-10 14:00:00", expireAt: "2026-01-10", remark: "年度会员（已到期）", createdAt: "2025-01-10 13:55:00",
    items: [{ type: "bundle", itemId: "bun4", itemName: "旗舰会员年卡", quantity: 1, unitPrice: 1999 }],
    statusHistory: [
      { status: "created",       label: "订单创建", time: "2025-01-10 13:55:00", remark: "用户下单" },
      { status: "auto_approved", label: "自动审核通过", time: "2025-01-10 13:55:01" },
      { status: "paid",          label: "支付完成", time: "2025-01-10 14:00:00", remark: "银行转账" },
      { status: "granted",       label: "权益生效", time: "2025-01-10 14:00:05", remark: "权益已发放" },
      { status: "expired",       label: "权益到期", time: "2026-01-10 23:59:59", remark: "权益有效期结束，自动到期" },
    ],
  },
  {
    // 已暂停订单
    id: "ord18", orderNo: "ORD202603100001", customerType: "B", customerId: "cust9", customerName: "红星美凯龙家居集团",
    orderType: "internal_grant", auditStatus: "approved", auditBy: "运营主管·张丽", auditAt: "2026-03-10 10:30:00",
    totalAmount: 0, paymentStatus: "no_payment", orderStatus: "suspended",
    remark: "企业合规检查期间暂停权益", createdAt: "2026-03-10 10:00:00",
    items: [{ type: "bundle", itemId: "bun3", itemName: "旗舰会员", quantity: 1, unitPrice: 0 }],
    statusHistory: [
      { status: "created",       label: "订单创建", time: "2026-03-10 10:00:00", remark: "运营创建内部订单" },
      { status: "pending_audit", label: "提交审核", time: "2026-03-10 10:00:01" },
      { status: "approved",      label: "审核通过", time: "2026-03-10 10:30:00", remark: "运营主管·张丽 审核通过" },
      { status: "granted",       label: "权益生效", time: "2026-03-10 10:30:05", remark: "权益已发放" },
